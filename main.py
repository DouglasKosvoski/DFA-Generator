...
A aplicação executa a carga de tokens (palavras reservadas, operadores, símbolos especiais, ...) e Regular Grammars (RG) from a given text file.

Input: file with the token and/or grammar relations from a 
Entrada: arquivo com a relação de tokens e/ou GRs dos tokens de uma linguagem hypothetical language.

Output: deterministic finite automaton (DFA), free from dead and unreacheable states.
into a CSV file table representation
"""
